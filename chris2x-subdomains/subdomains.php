...
/*
* Wordpress Info
Plugin Name: Chris2x Subdomains
Plugin URI: http://AmateurTraveler.com
Description: Setup your main categories, pages, and authors as subdomains and give them custom themes. Surely will come for more...
Version: 1.0
...
class WpsPlugin {
	...
	function addActions() {
		...
		//add_action( 'parse_wp', 'wps_action_parse_wp');
	}
